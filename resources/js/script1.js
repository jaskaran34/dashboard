...
window.update_chart=function(apiUrl,chart_code){
    ...
    .then(data => {
        ...
        if(chart_code=='2'){
            ...
            if(chart_code=='3'){
                ...
                if(chart_code=='4'){
                    ...
                    if(chart_code=='5'){
                        ...
                        if(chart_code=='6'){
                          //  console.log(data[0]['distinct_topic']);
                        ...
                        //data=JSON.parse(data);
                          ...
                          var htmlData1 = '<table class="table table-striped"> \
                          <thead> \
                     <tr class="bg-info text-white">\
                <th width="6%" style="border-right:2px solid white;text-align:center;" >Sector</th>\
                <th width="6%" style="border-right:2px solid white;text-align:center;"  >Distinct Topics</th>\
                <th width="6%" style="border-right:2px solid white;text-align:center;" >Distinct Swot</th>\
                <th width="6%" style="border-right:2px solid white;text-align:center;"  >Distinct Pestle</th>\
                <th width="6%" style="border-right:2px solid white;text-align:center;" >Max Intensity</th>\
                <th width="6%" style="border-right:2px solid white;text-align:center;"  >Distinct regions</th>\
               </tr>\
                </thead>\
                <tbody>';
                    ...
                    var htmlData2='<tr>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['sector']+'</th>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['distinct_topic']+'</th>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['distinct_swot']+'</th>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['distinct_pestle']+'</th>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['max_intensity']+'</th>\
                  <th  style="border-right:2px solid white;text-align:center;">'+data[0]['distinct_regions']+'</th>\
          </tr>';
          ...
          let htmlData=htmlData1+htmlData2+htmlData3;
          $('#modal1').find('.card-body').html(htmlData);
          ...
          //$('#modal1').find('.card-body').html(htmlData);
            //    $("#Modal5").modal('show');
          /*
          var header='<h5 class="modal-title">Monthly Report for Detail Head:  '+ head[0] + '</h5>';
              $('#Modal5').find('.modal-header').html(header);
              
              $('#Modal5').find('.modal-body').html(htmlData);
                $("#Modal5").modal('show');
               */          
///////////////                    
                            }
...
//$label_data_stacked_intensity[]
        ...
        const myChart_stacked = new Chart(ctx_stacked, {
            ...
            const myChart_bar_stacked = new Chart(ctx_bar_stacked, {
              ...
              const apiUrl_bar = `/api/filter_single_data_bar?label=`+label;
    
   console.log(apiUrl_bar);
   update_chart(apiUrl_bar,'6');
